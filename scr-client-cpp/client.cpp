...
#define __DRIVER_CLASS__ SimpleTest     // put here the name of your driver class
#define __DRIVER_INCLUDE__ "SimpleTest.h" // put here the filename of your driver h\\eader
